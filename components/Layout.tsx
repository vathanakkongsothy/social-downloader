...
export default function Layout() {
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48" className="mx-auto mb-4">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gradient-tiktok">TikTok Downloads</h3>
                <p className="text-gray-600">Download videos from TikTok easily.</p>
              </div>
              <div className="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48" className="mx-auto mb-4">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gradient-tiktok">YouTube Downloads</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gradient-tiktok">Facebook Videos</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gradient-tiktok">Instagram Reels</h3>
  ...
  .text-gradient-tiktok {
    background: linear-gradient(to right, #25F4EE, #FE2C55, #FE2C55);
